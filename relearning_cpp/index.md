...
* [Notes on concept of temporaries in C++](temporary_in_cpp.md)
* [Notes on the copy and swap idiom](copy_and_swap_idiom.md)
* [Notes on friend functions and classes](friend_functions_and_classes.md)
* [Notes on const volatile and mutable keywords](const_volatile_mutable.md)
* [Notes on unions in C++](unions_in_cpp.md)
* [Notes on block scope and namespace scope](block_and_namespace_scope.md)
* [Notes on uses of the using keyword](using_keyword_in_cpp.md)
